/**
 * WhatsApp Register - Request OTP for verification
 * POST /api/auth/whatsapp/request-register
 */
...
export async function POST(request: Request) {
  try {
    ...
    const { phone, email, username } = body;
    ...
    // Check if username already registered (if provided)
    if (username) {
    ...
    console.error("WhatsApp register request error:", error);
    return NextResponse.json(
