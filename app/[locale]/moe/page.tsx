...
export default async function MoePage({
  ...
  return (
    <div className="bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 h-screen h-dvh">
      <div className="container mx-auto h-full px-3 sm:px-4 lg:px-8 max-w-[1600px]">
        <Header />
