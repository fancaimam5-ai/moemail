    ...
    <div className="container mx-auto p-4 max-w-7xl">
      <div className="mb-4 text-center">
        ...
        <p className="text-sm text-muted-foreground">
          {message.emailExpiresAt && new Date(message.emailExpiresAt).getFullYear() === 9999
            ? tShared("permanent")
      ...
      <div className="border-2 border-primary/20 bg-background rounded-lg overflow-hidden h-[calc(100vh-200px)] lg:h-[calc(100vh-220px)]">
        <SharedMessageDetail
          message={{
            ...message,
