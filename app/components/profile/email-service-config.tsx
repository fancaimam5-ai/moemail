          ...
          <>
            <div className="space-y-2">
              <Label htmlFor="apiKey" className="text-sm font-medium">
                {t("apiKey")}
                {config.hasApiKey && (
                  <span className="ml-2 text-green-600 dark:text-green-400 font-medium text-xs">✓ Configured</span>
                )}
              </Label>
              <div className="relative">
                <Input
                  ...
                  placeholder={config.hasApiKey ? "Leave blank to keep current key" : t("apiKeyPlaceholder")}
                />
                <Button
                  type="button"
                  variant="ghost"
