...
import {Mail, Calendar, RefreshCw, Trash2, Share2, Search} from "lucide-react"
            ...
            {messages
              .filter(msg => {
                ...
                return (
                  ...
                  msg.to_address?.toLowerCase().includes(q)
                )
              })
              .map(message => (
              <div
                ...
                className={cn(
                  "p-3 hover:bg-primary/5 cursor-pointer group transition-colors duration-150",
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className={cn("text-sm truncate", message.is_read ? "font-medium" : "font-bold")}>{message.subject}</p>
